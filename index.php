...
// Login Form UI (Premium Glassmorphism)
if (!isset($_SESSION['logged_in'])) {
    ?>
    <!DOCTYPE html>
    <html lang="en">
    ...
    <style>
        ...
        .err { color: #f85149; margin-bottom: 15px; font-size: 14px; font-weight: bold; background: rgba(248, 81, 73, 0.1); padding: 10px; border-radius: 8px; }
    </style></head>
