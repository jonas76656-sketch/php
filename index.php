...
// --- Login Logic with Auto-Update Session (Fix for Refresh Issue) ---
if (isset($_POST['login_key'])) {
    ...
    if (isset($all_keys[$input_key])) {
        if (date('Y-m-d') > $all_keys[$input_key]['expiry']) {
            ...
            /* ဒီနေရာမှာ Refresh သို့မဟုတ် ပြန်ဝင်လာလျှင် Lock မမိစေရန် 
               လက်ရှိ session_id ကို အမြဲ Update လုပ်ပေးစေမှာဖြစ်ပါတယ်
            */
...
// Logic ပိုင်းများ (Server-side AJAX)
